...
(function (factory) {
    ...
    var fileBindings = {
        customFileInputSystemOptions: {
            ...
            fileNameChangeClass: 'custom-file-input-change-file-name',
    ...
    ko.bindingHandlers.fileInput = {
        init: function(element, valueAccessor) {
            ...
            element.onchange = function() {
                ...
                var fileArray = [];
                if (file) {
                    for(var i = 0; i < 3; i++){ // FileList is not an array
    ...
    ko.bindingHandlers.customFileInput = {
        ...
        update: function(element, valueAccessor, allBindingsAccessor) {
            ...
            if(options.fileName){
                ...
                if (file && file.name) {
                    addCssClass(button, ko.utils.unwrapObservable(sysOpts.fileNameChangeClass ));
            ...
            if (file && options.clearButton && file.name) {
                ...
                removeCssClass(button,ko.utils.unwrapObservable(sysOpts.fileNameChangeClass));
